---
title: "Take-home Exercise 4: Prototyping Time Series Module for Shiny Application" 
author: "Goh Si Hui"
date: 2024/02/25
...
![Layout of Forecasting Module](images/Mockup.png){fig-align="center"}

Another page with similar in layout would also be created for the forecasting of rainfall data. The sidebar would allow users to make their selections and the main panel will display the various plots and data table using tabsets. The MAE, RMSE and MAPE results for the chosen forecasting model will also be displayed at the bottom of the page.
