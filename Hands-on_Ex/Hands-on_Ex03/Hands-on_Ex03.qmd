...
::: column-margin
For ggirafe, it is an ggplot2 extension and it only has 3 types of interactivity functions:
...
The legends in the charts generated by ggplotly and plot_ly are also a filtering tool! When a particular race is selected, it will be filtered away.

Try the various functions on the "menu bar" within the plot. It allows us to perform actions such as lasso, zoom.
:::
