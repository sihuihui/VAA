...
::: panel-tabset
First, we will filter the data from year 2020, summarise the population count by grouping at PA, SZ and AG levels. Then we will pivot the table using pivot_wider so that the rows become columns.
