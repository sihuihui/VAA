...
In addition, we will be using the ToyotaCorolla.xls for Visualising Models and Parameters. We use `read_xls()` of readxl package to import the data worksheet of ToyotaCorolla.cls workbook into R. 
...
For our data, we will first bin the Math scores into a 4-class varialbe using `cut()`
